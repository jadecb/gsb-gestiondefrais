...
<head>
    <title>Visiteur - Toutes les fiches</title>
    <meta charset="utf-8">
    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            <div class="mt-4 col-md-12">
                ...
                <a href="/visiteur/consulter-mes-fiches"><button type="button" class="btn btn-secondary active">Toutes
                        mes fiches</button></a>
                ...
                <a href="/visiteur/consulter-mes-fiches/non-traitees"><button type="button" class="btn btn-secondary">
                        Fiches non traitées</button></a><br><br>

                Liste de toutes les fiches de frais.
