    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            ...
            <div class="mt-4 col-md-12">
                ...
                <a href="/admin/liste-utilisateurs"><button type="button" class="btn btn-secondary active">Tous
                        les utilisateurs</button></a>
                <a href="/admin/liste-visiteurs"><button type="button" class="btn btn-secondary">Tous les
                        visiteurs</button></a>
                <a href="/admin/liste-comptables"><button type="button" class="btn btn-secondary">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                        <form action={{ '/admin/utilisateur/edit/' . $user->id }}
                                                            ...
                                                            <p class="text-danger">Modifiez les champs souhaités</p>
