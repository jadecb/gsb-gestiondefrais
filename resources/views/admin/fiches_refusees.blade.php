...
<head>
    <title>Admin - Fiches refusées</title>
    <meta charset="utf-8">
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            ...
            <div class="mt-4 col-md-12">
                ...
                <a href="/admin/les-fiches"><button type="button" class="btn btn-secondary">Toutes
                        les fiches</button></a>
                <a href="/admin/les-fiches/acceptees"><button type="button" class="btn btn-secondary">Fiches
                        acceptées</button></a>
                <a href="/admin/les-fiches/refusees"><button type="button" class="btn btn-secondary active">
