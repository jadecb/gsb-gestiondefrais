...
<head>
    <title>Comptable - Fiches refusées</title>
    <meta charset="utf-8">
    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            ...
            <div class="mt-4 col-md-12">
                ...
                <a href="/comptable/fiches-non-traitees"><button type="button" class="btn btn-secondary">Fiches
                        non traitées</button></a>
                <a href="/comptable/fiches-acceptees"><button type="button" class="btn btn-secondary">Fiches
                        acceptées</button></a>
                <a href="/comptable/fiches-refusees"><button type="button" class="btn btn-secondary active">Fiches
                        refusées</button></a><br><br>

                Liste de toutes les fiches de frais refusées.
