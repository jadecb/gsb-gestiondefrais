<nav id="sidebar2">
    <div class="custom-menu">
        <button type="button" id="sidebar2Collapse" class="btn btn-primary">
        ...
        <ul class="list-unstyled components mb-5">
            ...
            <li>
                ...
                <ul class="collapse list-unstyled" id="homeSubmenu">
                    ...
                    <li>
                        <a href="/comptable/fiches-non-traitees"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                height="16" fill="currentColor" class="bi bi-file-earmark-arrow-up-fill"
                                viewBox="0 0 16 16">
                                <path fill-rule="evenodd"
                    ...
                    <li>
                        <a href="/comptable/fiches-acceptees"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                height="16" fill="currentColor" class="bi bi-file-earmark-check-fill"
                                viewBox="0 0 16 16">
                                <path fill-rule="evenodd"
                    ...
                    <li>
                        <a href="/comptable/fiches-refusees"><svg xmlns="http://www.w3.org/2000/svg" width="16"
            ...
            <li>
                <a href="/comptable/profil"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
            ...
            <li>
                <a href="/comptable/deconnexion"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
